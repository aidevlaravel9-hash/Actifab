...
class PanelBoardColourController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = $query->orderBy('panel_board_colour_id', 'desc')->get();
    ...
    {
        $PanelBoardColour = PanelBoardColour::findOrFail($id);
        $PanelBoardColour->delete();

        return redirect()
            ->route('panel-board-colour.index')
            ->with('success', 'Panel Board Colour deleted successfully.');
    }
