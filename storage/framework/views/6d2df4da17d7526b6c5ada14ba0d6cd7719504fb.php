                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td class="section-top-icons">
                                                <div class="icon-wrap">
                                                    <?php if($panel->submit_project == 0): ?>
                                                        <a href="<?php echo e(route('panel.show', [$panel->id, $section->id])); ?>"
                                                            class="icon-btn edit-btn">
                                                            <i class="fas fa-edit"></i>
                                                        </a>

                                                        <form action="<?php echo e(route('section.delete', $section->id)); ?>"
                                    ...
                                    <tr>
                                        ...
                                        <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td
                                                class="section-header-cell <?php echo e($index % 2 == 0 ? 'yellow-col' : 'green-col'); ?>">
                                                <div class="section-title">
                                                    <div>Section: <?php echo e($index + 1); ?></div>
                                                    <div>Width: <?php echo e($section->width); ?></div>
                                                    <div><?php echo e($section->section_name); ?></div>
                                                </div>
                                            </td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tr>
                                    ...
                                    <?php for($i = 0; $i < $maxFeeders; $i++): ?>
                                        <tr>
                                            <td class="left-grid-cell serial-cell"><?php echo e($i + 1); ?></td>
                                            <td class="left-grid-cell feeder-name-cell">F<?php echo e($i + 1); ?></td>
                                            ...
                                            <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                ?>
                                                <td
                                                    class="section-data-cell <?php echo e($index % 2 == 0 ? 'yellow-col' : 'green-col'); ?> red-text">
                                    ...
                                    <tr>
                                        ...
                                        <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td class="bottom-number-cell"><?php echo e($index + 1); ?></td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="card-body" style="background:#e5e5e5; padding:15px;">
                                ...
                                ">
                                        ...
                                        ">
                                            ...
                                            <div
                                                style="
                                    display:flex;
                                    width: <?php echo e($previewFrameWidth * $scale); ?>px;
                                    height: <?php echo e($panelOuterHeight); ?>px;
                                    background:#fff;
                                    border:none;
                                    box-sizing:border-box;
                                    position:relative;
                                ">
                                                ...
                                                <div
                                                    style="
                                                        position:absolute;
                                                        top: <?php echo e($sectionHeaderHeight); ?>px;
                                                        left:0;
                                                        right:0;
                                        ...
                                        ">
                                                        ...
                                                        <div
                                                            style="
                                                                position:relative;
                                                                height: <?php echo e($sectionHeaderHeight); ?>px;
                                                                display:flex;
                                                                align-items:center;
                                                                justify-content:center;
                                                                background:#f2f2f2;
                                                        ...
                                                        <?php $__currentLoopData = $section->feeders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feeder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div
                                                                style="
                                                                height: <?php echo e($feederPixelHeight); ?>px;
                                                                min-height: <?php echo e($feederPixelHeight); ?>px;
                                                            ...
                                                            ">
                                                                ...
                                                                <div style="text-align:center; line-height:1.35;">
                                                                    ...
                                                                    <?php if(!empty($feeder->FeederCategory->feeder_category_name)): ?>
                                                                        <div>
                                                                            <div>
                                                                                <?php echo e(\Illuminate\Support\Str::limit($feeder->FeederCategory->feeder_category_name, 10, '...')); ?>

                                                                            </div>
                                                                        </div>
                                                                        <div>
                                                                            <?php echo e(\Illuminate\Support\Str::limit($feeder->FeederType->feeder_type, 10, '...')); ?>

                                                                        </div>
                                                                        <div>
                                                                            <?php echo e(\Illuminate\Support\Str::limit($feeder->FeederSubType->feeder_sub_type, 10, '...')); ?>
                                                        ...
                                                        <?php if($remainingHeight > 0): ?>
                                                            ...
                                                            <div
                                                                style="
                                                    height: <?php echo e($remainingPixelHeight); ?>px;
                                                    min-height: <?php echo e($remainingPixelHeight); ?>px;
                                                    background:#fafafa;
                                                ">
                                                            </div>
                                                        <?php endif; ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/getdemo/Actifab/resources/views/panel/section-list.blade.php ENDPATH**/ ?>