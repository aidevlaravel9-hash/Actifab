...
<body
    ...
    <div class="card shadow border-0" style="max-width:420px; width:100%;">
        <div class="card-body p-4">
            <h4 class="text-primary text-center mb-2">Designer Login</h4>
            ...
            <form method="POST" action="<?php echo e(route('designer.login.post')); ?>">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
                ...
                <div class="mb-4 position-relative">
                    ...
                    <input type="password" name="password" id="designerPassword" class="form-control pe-5" required>
                    <button type="button"
                        class="btn btn-link position-absolute end-0 top-50 text-muted text-decoration-none"
                        onclick="toggleDesignerPassword()">
                        <i class="ri-eye-fill" id="designerPasswordIcon"></i>
                    </button>
                </div>
    ...
    <script>
        function toggleDesignerPassword() {
            const passwordInput = document.getElementById('designerPassword');
            const passwordIcon = document.getElementById('designerPasswordIcon');
...
<?php /**PATH C:\laragon\www\Actifab\resources\views/designer_auth/login.blade.php ENDPATH**/ ?>