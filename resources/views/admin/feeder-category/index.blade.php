...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                 <form action="{{ route('feeder-category.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <tbody>
                                            @foreach ($data as $row)
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        @if ($row->image)
                                                            <img src="{{ asset('uploads/feeder_category/' . $row->image) }}"
                                                                width="50" height="50"
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('feeder-category.update') }}">
                @csrf
...
@section('scripts')
    ...
    <script>
        $('.editBtn').on('click', function() {
            ...
            $.get("{{ url('admin/feeder-category/edit') }}/" + id, function(data) {
                ...
                if (data.image) {
                    $('#editImageTag').attr(
                        'src',
                        "{{ asset('uploads/feeder_category') }}/" + data.image
                    );
        ...
        //         // ðŸ”¥ THIS LINE IS MISSING (MAIN FIX)
        //         $('#edit_section_master_id').val(data.section_master_id);
