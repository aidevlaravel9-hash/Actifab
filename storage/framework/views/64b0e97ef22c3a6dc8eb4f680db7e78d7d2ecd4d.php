                ...
                <li class="nav-item">
                    ...
                    <div class="menu-dropdown collapse show" id="sidebarMore" style="">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('manager-designer-user.index')); ?>"
                                    class="nav-link <?php echo e(request()->is('admin/manager-designer-user*') ? 'active' : ''); ?>">
                                    <i class="nav-icon fas fa-list"></i>
                                    Users
                                </a>
                            </li>
...
<?php /**PATH C:\laragon\www\Actifab\resources\views/common/admin/sidebar.blade.php ENDPATH**/ ?>