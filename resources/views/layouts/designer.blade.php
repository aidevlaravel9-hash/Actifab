...
@include('common.designer.head')

<body>
    <div id="layout-wrapper">
        @include('common.designer.header')@include('common.designer.sidebar')@yield('content')@include('common.designer.footer')</div>
    @include('common.designer.footerjs')
