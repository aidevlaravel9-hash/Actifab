                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    {{-- Edit Button --}}
                                                    <a href="{{ route('EditPanelBoard', [$panel->project_id, $panel->id]) }}"
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-danger delete-btn"
                                                        data-id="{{ $panel->id }}"
                                                        data-name="{{ $panel->panel_board_name }}" data-bs-toggle="modal"
                                            ...
                                            <td>{{ $panel->frame_height ?? '-' }}</td>
                                            <td>{{ $panel->frame_width ?? '-' }}</td>
                                            <td>{{ $panel->frame_depth ?? '-' }}</td>
                                            <td>{{ $panel->panelAccess->panel_access ?? '-' }}</td>
