                ...
                <div class="row">
                    ...
                    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <form method="POST" action="{{ route('feeder-sub-type.update') }}">
                                @csrf
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <select name="feeder_type_id" id="edit_feeder_type_id" class="form-control">
                                                @foreach ($feederTypes as $type)
                                                    <option value="{{ $type->feeder_type_id }}">{{ $type->feeder_type }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Feeder Sub Type <span
                                                    style="color:red;">*</span></label>
                                            <input type="text" name="feeder_sub_type" id="edit_feeder_sub_type"
                                                class="form-control">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Status</label>
