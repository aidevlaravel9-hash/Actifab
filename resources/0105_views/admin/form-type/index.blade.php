        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header">Add Form Type</div>
                            <div class="card-body">
                                <form action="{{ route('form-type.store') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                {{--  <form method="GET" class="d-flex">
                                    <input type="text" name="search" class="form-control me-2"
                                        value="{{ request('search') }}" placeholder="Search Form Type">
                                    <button class="btn btn-outline-primary me-2">Search</button>
                                    <a href="{{ route('form-type.index') }}" class=" btn btn-outline-secondary">
                                        Clear
                                    </a>
                                </form>  --}}
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="formType" class="table table-hover">
                                        <thead>
                                            <tr>
                                            ...
                                            @foreach ($data as $row)
                                                <tr class="text-center">
                                                    <td><input type="checkbox" class="recordCheckbox"
                                                            value="{{ $row->form_type_id }}"></td>
                                                    <td>
                                                        <button class="btn btn-sm btn-info editBtn"
                                                            data-id="{{ $row->form_type_id }}"
                                                            data-value="{{ $row->form_type }}"
                ...
                <div class="modal fade" id="editModal" tabindex="-1">
                    <div class="modal-dialog">
                        <form method="POST" action="{{ route('form-type.update') }}" class="modal-content">
                            @csrf
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label>Form Type <span style="color:red;">*</span></label>
                                    <input type="text" name="form_type" id="edit_value" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label>Status</label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteModal.addEventListener('show.bs.modal', function(event) {
                ...
                var url = "{{ route('form-type.delete', ':id') }}";
        ...
        $('#deleteSelected').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ route('form-type.bulkDelete') }}",
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            ids: ids
